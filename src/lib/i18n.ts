export const translations = {
  es: {
    ...
    plans: {
        ...
        imageGeneratedSuccess: "¡Imagen generada con éxito!",
        nameRequiredForImage: "El nombre del ejercicio es necesario para generar la imagen.",
        error: "Error",
  ...
  en: {
    ...
    plans: {
        ...
        nameRequiredForImage: "Exercise name is required to generate an image.",
        error: "Error",
        equipment: "Equipment",
